    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#"><i class="bi bi-person me-2"></i>Residents</a>
                </li>
                <li>
        ...
        <div id="content" class="p-0">
            ...
            <div class="container-fluid px-3">
                <h2>Welcome to Residents View, {{Auth::user()->name}}!</h2>
                <p>Table goes brrtttt</p>
                <a href="/addresidents" class="btn btn-primary mb-3">
                    <i class="bi bi-plus-circle me-2"></i>Add New Resident
                </a>
